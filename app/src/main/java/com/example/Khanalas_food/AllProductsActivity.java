...
//    private static String url_all_products = "https://api.android_test.info/android_connect/get_all_products.php";
//
//    // JSON Node names
...
//                    json = (JSONObject)jParser.parse(response.toString());
                    json = new JSONObject(response.toString());
                } else {
                    Log.d("Get line: ", "GET request not worked");
                }
